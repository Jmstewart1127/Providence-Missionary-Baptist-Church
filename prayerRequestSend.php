...
<body>
  ...
  <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="row">
            <div class="box">
                <div class="col-sm-4 col-md-8 col-lg-12">
                    ...
                    <hr>
                    <form role="form" action="sendMail.php" method="POST" id="database" enctype="multipart/form-data>
                        <div class="row">
                            <div class="col-sm-4 col-md-8 col-lg-12">
                                <label>Name</label>
							...
							<div class="posted"><br>
								<p id="message" style="font-size: 100%;"></p>
							</div>
                        </div>
                    </form>
                </div>
		...
		<div class="row">
            <div class="box">
                <div class="col-sm-4 col-md-8 col-lg-12">
                    ...
                    <hr>
                    <form role="form" action="prayerRequestSend.php" method="POST" id="databas3" enctype="multipart/form-data>
                        <div class="row">
                            <div class="col-sm-4 col-md-8 col-lg-12">
                                <label>Name</label>
                                <input type="text" class="form-control" name="name">
                            ...
                            <div class="form-group col-sm-4 col-md-8 col-lg-12">
                                <input type="hidden" name="save" value="contact">
                                <button type="submit" id="submi7" class="btn btn-default">Submit</button>
                            </div>
							<div class="post3d"><br>
								<p id="messag3" style="font-size: 100%;">Submission Successful</p>
							</div>
                        </div>
                    </form>
                </div>
	...
	<script src="js/thisfile.js"></script>
...
$mail->Subject = 'New Prayer Request';
$mail->Body    = '<b>Name:</b>' .$name. '<br><b>Email Address:</b> ' .$email. '<br> <b>Message:</b> ' .$message. '<br>';
...
$link = mysqli_connect('localhost', 'root', 'Js1029492', 'pmbc2');
